...
interface DispatchToProps {
  addTimeEntry: (taskId: string, from: string, to: string) => AddEntry;
}
...
function mapDispatchToProps(
  ...
  return {
    addTimeEntry: (taskId: string, from: string, to: string) =>
      dispatch(addEntry(ownProps.projectId, taskId, { from, to }))
  };
}
  ...
  submitEntryHandler = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isTimeEntry(this.state.timeEntry)) {
      this.props.addTimeEntry(
        ...
        this.state.timeEntry.from,
        this.state.timeEntry.to
      );
    }
  };
...
const AddTimeConnector: React.ComponentClass<OwnProps> = connect<
  StateToProps,
  DispatchToProps,
  OwnProps
